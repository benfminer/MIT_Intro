...
def get_guess(letter):
    '''
    letter: string to hold guess
    '''

    print('You have ', guesses, 'left.')
    print('Available letters : ', get_available_letters(letters_guessed))
    return letter = str(input('Please enter a letter: '))
...
def hangman(secret_word):
    ...
    * After each guess, you should display to the user the
    ...
    letters_guessed = []
    letter = ''
    is_letter = string.ascii_lowercase
    warnings = 3
    ...
    while guesses > 0 or is_word_guessed(secret_word, letters_guessed):
        print('You have ', guesses, 'left.')
        print('Available letters : ', get_available_letters(letters_guessed))
